...
\newcommand{\showlogo}{
    ...
    \begin{picture}(0pt,0pt)(2cm,-2cm)
        ...
        % \put(13cm,-2cm){\includegraphics[height=3.5cm]{images/rwth-fh-logo.png}}
        \put(17cm,-4cm){\includegraphics[height=5cm]{images/fh-logo-right.png}}
        \put(-0.5cm,-2.3cm){\includegraphics[height=5cm]{images/RWTH-Aachen-University.png}}
    \end{picture}
